...
// MOBILE FIX: Smaller bottom spacing to avoid overlapping content, smaller info text
...
const MusicPlayer = () => {
  ...
  return (
    /* MOBILE FIX: bottom-4 on mobile, bottom-6 on desktop; right-4 on mobile */
    <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-50 flex flex-col items-center space-y-2">
      {/* Hide info text on very small screens to save space */}
      <p className="text-xs text-gray-300 italic hidden sm:block text-center max-w-28">{infoText}</p>
      ...
      <button
        ...
        className="p-3 sm:p-4 rounded-full shadow-lg transition transform hover:scale-110 touch-manipulation"
        style={{
